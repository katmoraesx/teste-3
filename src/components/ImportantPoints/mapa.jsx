...
const predios = [
  ...
  { id: "165", tipo: "numero-predio", x: "57.6%", y: "31%" },
  { id: "325", tipo: "numero-predio", x: "58.2%", y: "41.5%" },
  { id: "169", tipo: "numero-predio", x: "58.6%", y: "37%" },
  { id: "300", tipo: "numero-predio", x: "59.2%", y: "47.8%" },
  { id: "320", tipo: "numero-predio", x: "60.4%", y: "55.4%" },
  { id: "150", tipo: "numero-predio", x: "67%", y: "60.5%" },
  { id: "151", tipo: "numero-predio", x: "71.5%", y: "58.6%" },
...
export default function Mapa() {
  ...
  return (
    <div className="flex justify-center mt-10 space-x-10">
      ...
      >
        {predios.map((predio) => (
          <div
            key={predio.id}
            className="absolute text-black-900 font-extrabold text-xs bg-black-300 px-1 rounded shadow"
            style={{
              left: predio.x,
              top: predio.y,
    ...
    ${
      ponto.tipo === "ponto-encontro"
        ? "bg-green-600 w-8 h-5 rounded-sm"
        : "bg-red-600 w-6 h-6 rounded-full"
    }
